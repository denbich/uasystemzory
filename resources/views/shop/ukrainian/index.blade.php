          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">{{ __('shop.refugees.list.title') }}</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('s.ukrainian.list') }}">{{ __('shop.sidemenu.general.refugees.list') }}</a></li>
                  </ol>
                </nav>
              </div>
        ...
        <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">{{ __('shop.refugees.list.title') }}</h3>
                </div>
                <div class="col-4 text-right">
                  <a href="#generatemodal" data-toggle="modal" data-target="#generatemodal" class="btn btn-sm btn-primary d-none"><i class="fas fa-clipboard-list"></i> {{ __('shop.refugees.list.button') }}</a>
                </div>
              </div>
            </div>
              <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody class="list">
                            ...
                            @empty
                                <h2 class="text-center text-danger">{{ __('shop.refugees.list.norefugees') }}</h2>
                            @endforelse
                        </tbody>
                    </table>
                </div>
