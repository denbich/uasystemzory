          ...
          <div class="header-body text-center mb-6">
            <div class="row justify-content-center">
              <div class="col-xl-8 col-lg-8 col-md-8 px-5">
                <h1 class="display-1 text-white mt-3 font-weight-700">{{ Str::upper(__('Zmień hasło')) }}</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center"> <!--   -->
            <div class="card bg-secondary border-0 mb-0 col-lg-5 col-md-7">
                      <div class="card-header bg-transparent text-center">
                          <div class="h2"> {{ __('Ustaw nowe hasło, którym będziesz się logować do uaSystem') }}</div>
                        </div>
                        <div class="card-body pt-lg-3 pb-lg-4 px-lg-5">
                          ...
                          <form method="POST" action="{{ route('password.confirm') }}">
                              ...
                              <div class="form-group">
                                  ...
                                  <div>
                                      <button type="submit" class="btn btn-info text-dark btn-user btn-block">{{ __('Zmień hasło') }}</button>
